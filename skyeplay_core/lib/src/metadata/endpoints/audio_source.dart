...
class MetadataPluginAudioSourceEndpoint {
  ...
  Future<List<SpotubeAudioSourceMatchObject>> matches(
    ...
    return raw.map((e) => SpotubeAudioSourceMatchObject.fromJson((e as dynamic).toJson())).toList();
  }
  ...
  Future<List<SpotubeAudioSourceStreamObject>> streams(
    ...
    return raw.map((e) => SpotubeAudioSourceStreamObject.fromJson((e as dynamic).toJson())).toList();
  }
}
